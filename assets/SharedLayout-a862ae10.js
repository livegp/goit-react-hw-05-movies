import{s as A,j as h,G as Be,N as Ft,g as Mt,r as l,u as Rt,c as Pt,L as Lt,O as kt}from"./index-43a8e44b.js";import{A as Dt,I as Nt}from"./index.esm-b897a791.js";import Vt from"./Loader-d194a504.js";import{Q as Bt}from"./react-toastify.esm-6ccd8295.js";const Ut=A.div`
  display: grid;
...
`,Xs=A(Ys)`
  animation: ${yt} 0.5s;
`;function Js(){const[e,r]=l.useState(()=>{const n=window.matchMedia("(prefers-color-scheme: dark)").matches;return localStorage.getItem("theme")||(n?"dark":"light")});l.useEffect(()=>{localStorage.setItem("theme",e)},[e]),l.useEffect(()=>{const{body:n}=document;n.dataset.theme=e},[e]);const t=()=>{r(e==="light"?"dark":"light")};return h.jsxs(Zs,{className:"switcher",children:[h.jsx("input",{type:"checkbox",onChange:t,checked:e==="dark"}),e==="dark"?h.jsx(qs,{}):h.jsx(Xs,{})]})}function Qs(){return h.jsx(Kt,{children:h.jsxs(Wt,{children:[h.jsx(Yt,{children:h.jsxs(Lt,{to:"/",children:[h.jsx(Gt,{}),h.jsx("p",{children:"Movie"})]})}),h.jsx(Zt,{children:h.jsxs("ul",{children:[h.jsx("li",{children:h.jsx(dr,{to:"/",children:"Home"})}),h.jsx("li",{children:h.jsx(dr,{to:"/movies",children:"Movies"})})]})}),h.jsx(Ks,{}),h.jsx(Js,{}),h.jsx(qt,{type:"button",children:h.jsx(Nt,{})}),h.jsx(Jt,{})]})})}const ec=A.main``;function rc(){return h.jsx(ec,{children:h.jsx(Br,{children:h.jsx(l.Suspense,{fallback:h.jsx(Vt,{}),children:h.jsx(kt,{})})})})}function sc(){return h.jsxs(Ut,{children:[h.jsx(Qs,{}),h.jsx(rc,{}),h.jsx(Ht,{})]})}export{sc as default};
